...
print "\nReading Images"            
harrisImage1 = (np.array(Image.open('arch1.png').convert('L'), dtype=np.float32))
harrisImage2 = (np.array(Image.open('arch2.png').convert('L'), dtype=np.float32))
...
maxOfImage1, maxOfImage2, maxOfDotProduct, originalMatrix, thresholdedMatrix, pairsList = matchDescriptors(descriptors1, descriptors2)
...
colourImage1 = Image.open('arch1.png')
colourImage2 = Image.open('arch2.png')
